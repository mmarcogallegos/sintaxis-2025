...
TipoSimboloGramatical=( tProgram , tIdentificador , tPuntoYComa , tBegin , tEnd , tPunto , tVar , tDosPuntos , tReal , tCadena , tOperadorAsignacion , tMas , tMenos , tConcatenacion , tProducto , tDivision , tPotencia , tConstanteReal , tConstanteCadena , tParentesisAbre , tParentesisCierra , tRaiz , tExtraerSubcadena , tComa , tBuscarSubcadena , tLongitudCadena , tWhile , tDo , tOperadorLogicoOR , tOperadorLogicoAND , tOperadorLogicoNOT , tOperadorRelacional , tIf , tThen , tElse , tRead , tWrite , pesos , error , 

vPrograma , vDeclaracionVariables , vCuerpoVar , vCuerpoVarII , vTipoVar , vCuerpo , vSentencia , vAsignacion , vExpresion , vExpresionII , vTermino , vTerminoII , vFactor , vFactorII , vMayorPrecedencia , vCiclica , vCondicion , vCondicionII , vTerminoAnd , vTerminoAndII , vTerminoLogico , vComparacion , vCondicional , vCondicionalFin , vLectura , vLecturaII , vEscritura , vTipoEscritura , vTipoEscrituraII);
...
begin
     ...
     tablaSimbolos.elem[11].componenteLexico := tOperadorLogicoAND;
     tablaSimbolos.elem[11].lexema := 'AND';
     tablaSimbolos.elem[12].componenteLexico := tOperadorLogicoOR;
     tablaSimbolos.elem[12].lexema := 'OR';
     tablaSimbolos.elem[13].componenteLexico := tOperadorLogicoNOT;
     ...
     tablaSimbolos.elem[18].componenteLexico := tConcatenacion;
     tablaSimbolos.elem[18].lexema := 'CONCAT';
     tablaSimbolos.elem[19].componenteLexico := tExtraerSubcadena;
     tablaSimbolos.elem[19].lexema := 'EXTRACT';
     tablaSimbolos.elem[20].componenteLexico := tBuscarSubcadena;
     tablaSimbolos.elem[20].lexema := 'SEARCHSTR';
     tablaSimbolos.elem[21].componenteLexico := tLongitudCadena;
     tablaSimbolos.elem[21].lexema := 'LENGTH';
end;
          //buscarEnTS
procedure InstalarEnTablaDeSimbolos(var tablaSimbolos:TablaDeSimbolos ; var componenteLexicoLeido:tipoSimboloGramatical ; var lexemaLeido:string);
var
